...
class SuperSlides extends StylePluginBase {
  ...
  protected function defineOptions() {
    ...
    $options['autoplayinterval'] = array('default' => 1000);
    $options['show_animation'] = array('default' => 'fadeIn');
    $options['duration'] = array('default' => 0);
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $form['global']['slideshow_animation'] = array(
      '#type' => 'select',
    ...
    for ($i = 0; $i < count($field_labels); $i++) {
      ...
      $form[$field_labels[$i]]['duration'] = array(
        '#type' => 'number',
